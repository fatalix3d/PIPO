...
public class CameraPerspectiveEditor : MonoBehaviour
{
	...
	public float
		dollyZoom = 0;
	public float dollyZoomFocalDistance = -1;
	...
	public void Awake ()
	{
		...
		if (dollyZoomFocalDistance < 0)
		{
			dollyZoomFocalDistance = (thisCamera.farClipPlane - thisCamera.nearClipPlane) / 2;
		}
	}
	...
	public void OnPreCull ()
	{
		...
		{
			targetMatrix.m02 = lensShift.x * 2;
			targetMatrix.m12 = lensShift.y * 2;
		...
		//Position Shift 
		targetMatrix.m03 = positionShift.x * 2;
		targetMatrix.m13 = positionShift.y * 2;
		
		//Skew
		targetMatrix.m01 = skew.x * 2;
		targetMatrix.m10 = skew.y * 2;
		...
		//Clipping Plane Skew
		targetMatrix.m20 = clippingPlaneSkew.x * 2;
		targetMatrix.m21 = clippingPlaneSkew.y * 2;
		...
		if (!thisCamera.orthographic)
		{
			...
			invertedNormalizedDollyZoomFocalDistance = 1 - ((dollyZoomFocalDistance - currentNearClipPlane) / dollyZoomDenominatorCache);
			targetMatrix.m22 = ((-(currentNearClipPlane + currentFarClipPlane) / dollyZoomDenominatorCache) - dollyZoom) + (2 * invertedNormalizedDollyZoomFocalDistance * dollyZoom);
			targetMatrix.m23 = (((-2 * currentNearClipPlane * currentFarClipPlane) / dollyZoomDenominatorCache) - (currentFarClipPlane * dollyZoom)) + ((currentNearClipPlane + currentFarClipPlane) * invertedNormalizedDollyZoomFocalDistance * dollyZoom);
		}
	...
	public Vector3 WorldToScreenPoint (Vector3 position)
	{
		...
		Debug.Log("WorldToScreenPoint: " + pointConversionPosition);
	...
	public Vector3 WorldToViewportPoint (Vector3 position)
	{
		...
		pointConversionPosition.z = 0;
		
		Debug.Log("WorldToViewportPoint: " + pointConversionPosition);
		return pointConversionPosition;
	}
	...
	private float _currentScreenHeight = 0;
	...
	private float _currentScreenWidth = 0;
